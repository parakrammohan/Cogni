...
const SYMBOL_PAIRS = ["7H", "H7", "3E", "E3", "5S", "S5", "8B", "B8", "2Z", "Z2", "6G", "G6"];
    ...
    <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
      <div className="rounded-[24px] border border-slate-300 bg-white p-5">
        <div className="text-xs uppercase tracking-[0.3em] text-slate-500">
          {t("visualSearchGame.processingSpeedVisualSearch")}
        </div>
        <h3 className="mt-2 font-display text-3xl text-ink">{t("visualSearchGame.targetScan")}</h3>
        <p className="mt-3 text-base leading-7 text-slate-600">
          {t("visualSearchGame.aCompactVisualSearchDrillBuiltAr")}
        </p>
        <div className="mt-5 flex flex-wrap gap-3">
          <Badge tone="info">
            {t("visualSearchGame.round")} {round}/6
          </Badge>
        ...
        <div className="rounded-[22px] border border-slate-300 bg-white p-5">
          <div className="flex items-center gap-3 text-slate-500">
            ...
            <span className="text-xs uppercase tracking-[0.28em]">
              {t("visualSearchGame.findThisTarget")}
            </span>
          </div>
