...
export function BottomNav<T extends string>({
  ...
  return (
    <>
      <nav
        aria-label={t("bottomNav.primaryNavigation")}
  ...
  return (
    <button
      ...
      className={cx(
        ...
        isActive ? "text-cyan-700" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900",
      )}
    >
      <span
        className={cx(
            ...
            <DialogPrimitive.Content asChild>
              ...
              >
                ...
                <DialogPrimitive.Title className="px-5 pt-1 text-xs font-semibold uppercase tracking-wider text-slate-500">
                  {t("bottomNav.morePages")}
                </DialogPrimitive.Title>
                <DialogPrimitive.Description className="sr-only">
                  {t("bottomNav.additionalNavigation")}
                        ...
                        >
                          <span
                            className={cx(
                              ...
                              isActive ? "bg-cyan-100 text-cyan-700" : "bg-slate-50 text-slate-600",
                            )}
                            aria-hidden
                          >
                            <Icon size={18} />
